...
class LiveThreatScorer:
    ...
    def score(self, lat: float, lon: float) -> float:
        ...
        for z in self.zones:
            ...
            # FIX: support both 'adj_severity' (static zones) and 'severity' (live zones)
            severity = z.get("adj_severity", z.get("severity", 0))
            total += severity * influence
...
if __name__ == "__main__":
    ...
    for origin, dest, cargo, val in [
        ...
        fname = f"gmaps_{origin}_{dest}.json"
